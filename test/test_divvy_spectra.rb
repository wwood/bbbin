...
describe script_under_test do
  it 'should do 1 protein hit' do
    ...
    stderr.should eq("")
    answer = "ID\tUnique spectra\tNon-unique spectra\tEstimated total spectra\tNormalised spectral count\tDescription\n"+
  ...
  it 'should do peptides that hit 2 proteins' do
    ...
    stderr.should eq("")
    answer = "ID\tUnique spectra\tNon-unique spectra\tEstimated total spectra\tNormalised spectral count\tDescription\n"+
    ['Mstor_v4.3.2:1344','37','151','89.7075471698113','0.29509061569016876','Methanoflorens_stordalmirensis_v4.3.2_01361 Methyl-coenzyme M reductase I subunit gamma '+"\n"].join("\t")+
    ['eDeep20120820:eD1_8237_2','69','151','167.29245283018867','0.5503041211519364','methyl-coenzyme M reductase gamma subunit # pI:8.94 MW:27683 '+"\n"].join("\t")+
  ...
  it 'should do peptides that hit more than 2 proteins' do
    ...
    stderr.should eq("")
    answer = "ID\tUnique spectra\tNon-unique spectra\tEstimated total spectra\tNormalised spectral count\tDescription\n"+
    ['Mstor_v4.3.2:1344','37','151','89.7075471698113','0.24781090378400913','Methanoflorens_stordalmirensis_v4.3.2_01361 Methyl-coenzyme M reductase I subunit gamma '+"\n"].join("\t")+
    ['eDeep20120820:eD1_8237_2','69','151','167.29245283018867','0.46213384759720627','methyl-coenzyme M reductase gamma subunit # pI:8.94 MW:27683 '+"\n"].join("\t")+
    ['eDeep20120820:eD1_1639_1','47','0','47.0','0.1298342541436464','chaperonin GroEL # pI:9.22 MW:10181 '+"\n"].join("\t")+
    ['eDeep20120820:eD1_13975_5','9','1','9.157894736842106','0.02529805175923234','chaperonin GroEL # pI:6.58 MW:12040 '+"\n"].join("\t")+
    ['eDeep20120820:eD1_3396_1','38','1','38.666666666666664','0.10681399631675874','TGroEL # pI:9.70 MW:6451 '+"\n"].join("\t")+
    ['eDeep20120820:eD1_1494_8','10','1','10.175438596491228','0.028108946399147038','chaperonin GroEL # pI:4.93 MW:54101 '+"\n"].join("\t")
  ...
  it 'should do 1 protein with an alias' do
    ...
    stderr.should eq("")
    answer = "ID\tUnique spectra\tNon-unique spectra\tEstimated total spectra\tNormalised spectral count\tDescription\n"+
    ['Mstor_v4.3.2:1344','0','188','94.0','0.5','Methanoflorens_stordalmirensis_v4.3.2_01361 Methyl-coenzyme M reductase I subunit gamma '+"\n"].join("\t")+
    ['alias1','0','188','94.0','0.5','alias1 Methyl-coenzyme M reductase I subunit gamma '+"\n"].join("\t")
