...
if __name__ == '__main__':
    ...
    parser.add_argument('-2', '--output_read2', help='output read2 file')
    ...
    with open(args.i) as in_io:
        with open(args.output_read1,'w') as o1:
            if args.output_read2 is None:
                ReadSimulator.simulate_reads(in_io, args.read_len, args.step_size, args.insert_size, o1, None)
            else:
